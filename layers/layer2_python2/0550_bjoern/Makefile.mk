...
all:: $(PYTHON2_SITE_PACKAGES)/$(NAME)-3.0.0-py$(PYTHON2_SHORT_VERSION)-linux-x86_64.egg
$(PYTHON2_SITE_PACKAGES)/$(NAME)-3.0.0-py$(PYTHON2_SHORT_VERSION)-linux-x86_64.egg:
